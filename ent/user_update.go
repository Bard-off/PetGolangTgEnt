...
func (_u *UserUpdate) SetTgID(v string) *UserUpdate {
	_u.mutation.SetTgID(v)
	return _u
}

// SetNillableTgID sets the "TgID" field if the given value is not nil.
func (_u *UserUpdate) SetNillableTgID(v *string) *UserUpdate {
	if v != nil {
		_u.SetTgID(*v)
	}
	return _u
...
func (_u *UserUpdate) check() error {
	if v, ok := _u.mutation.TgID(); ok {
		if err := user.TgIDValidator(v); err != nil {
			return &ValidationError{Name: "TgID", err: fmt.Errorf(`ent: validator failed for field "User.TgID": %w`, err)}
		}
	}
...
// SetTgID sets the "TgID" field.
func (_u *UserUpdateOne) SetTgID(v string) *UserUpdateOne {
	_u.mutation.SetTgID(v)
	return _u
}

// SetNillableTgID sets the "TgID" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableTgID(v *string) *UserUpdateOne {
	if v != nil {
		_u.SetTgID(*v)
	}
	return _u
